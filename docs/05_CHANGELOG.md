...
- Backend regression and desktop/390px browser checks passed. Read-only live
  ...
  Tokens as the independent audit. Owner-authorized rollout completed: release
  `87adb639`, successful COS run `35097038528`; live code and static bytes verified.
...
Static-only release 20260914-speaking-set-headers-1 is deployed: commit 511fa02a,
successful COS run 34826007745 and five live file-byte matches. No backend or
...
- Changed the Student Library's initial Practice category from `BBC2024` to
  `BBC2026` without reordering the category choices.
- Returning from Exam to Practice now restores `BBC2026` as the Practice
  default.
