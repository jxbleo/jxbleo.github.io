...
**Listening Entry**:
One contextual entry from a listening-comprehension card to its linked material.
The dedicated Listening Library displays safe Dictation progress.

**Listening Material**:
One audio/video source with reviewed canonical units, private Dictation answer
slots and an optional linked comprehension exercise. Dictation is the only
practice mode since 2026-09-22; it is self-study, without new assignments or STARs.

**Listening Track Progress**:
A learner's permanent Dictation completion state for one material/content scope.
Historical records and accepted time are preserved across content replacement.

**Listening Draft**:**Listening Draft**:
...
_Avoid_: Complete Listening Material
...
**Source Media**:
The complete audio or video used by one Listening Material. Unit boundaries
refer to media positions rather than physically cut files.
