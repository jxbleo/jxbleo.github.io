...
assert(dispatcherSource.includes("smtp_accepted_count"));
assert(dispatcherSource.includes("smtp_rejected_count"));
assert(dispatcherSource.includes("smtp_response_code"));
assert(dispatcherSource.includes("smtp_response"));
assert(!dispatcherSource.includes("diagnoseSmtp"));
assert(!dispatcherSource.includes("diagnoseAttemptEmail"));
