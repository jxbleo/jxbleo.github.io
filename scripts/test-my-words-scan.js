...
assert(html.includes("data-scan-progress") && html.includes("data-scan-progress-track") && html.includes("Thinking"));
...
assert(js.includes("exportProcessed") && js.includes("3000") && js.includes("else if (target.closest('[data-scan-next]')) upload()"));
assert(!js.includes("setPhase('edit')"));
...
assert(js.includes("removeArmedKey") && js.includes("openCandidateRemoveConfirm") && js.includes("confirmCandidateRemoval"));
assert(js.includes("Tap the red item above to remove it.") && !js.includes("if (state.selected.has(key)) state.selected.delete(key)"));
...
assert(js.includes("is-remove-armed") && js.includes("my-words-scan-candidate-remove-mark"));
assert(!js.includes("context.textContent = candidate.context") && !js.includes("remove.textContent = candidate.status"));
...
assert(css.includes("myWordsScanThinking") && css.includes("my-words-scan-thinking") && css.includes("-webkit-touch-callout: none"));
assert(css.includes("position: sticky") && css.includes("top: var(--scan-sticky-top)") && css.includes("overflow-y: auto"));
assert(css.includes(".my-words-scan-candidate-list") && css.includes("flex-wrap: wrap") && css.includes("width: auto"));
assert(css.includes("my-words-scan-remove-confirm") && css.includes("my-words-scan-danger-button"));
