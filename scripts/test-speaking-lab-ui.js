...
function run() {
  ...
  assert.match(teacherPage, /speaking-lab\.css\?v=20260914-ir-unified-headers-1/);
  ...
  assert.match(page, /speaking-lab\.css\?v=20260914-ir-unified-headers-1/);
  assert.match(page, /speaking-lab\.js\?v=20260914-ir-unified-headers-1/);
