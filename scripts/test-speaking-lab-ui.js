...
function run() {
  ...
  assert.match(app, /setRecordButton\(stoppedEarly \? 'Start Over' : 'Finished', 'finished'\)/);
  ...
  assert.match(page, /speaking-lab\.css\?v=20260913-response-recorder-3/);
  assert.match(page, /speaking-lab\.js\?v=20260913-response-recorder-3/);
