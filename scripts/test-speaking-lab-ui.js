...
function run() {
  ...
  for (const html of [page, teacherPage]) {
    assert.match(html, /speaking-lab\.css[\s\S]*speaking-discussion-recorder\.css\?v=20260913-discussion-spacing-1/);
  }
  ...
  assert.match(page, /speaking-lab\.css\?v=20260913-ir-saved-mic-1/);
  assert.match(page, /speaking-lab\.js\?v=20260913-speaking-wake-lock-1/);
