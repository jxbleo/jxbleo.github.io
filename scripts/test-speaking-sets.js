...
const expected = [
  ["dse-p4-mock-2019-screen-time-controls-for-teenagers", 2019, null, "Screen-time Controls for Teenagers", "Apple Screen Control"],
  ["dse-p4-mock-2019-translation-apps-and-language-learning", 2019, null, "Translation Apps and Language Learning", "Translation Apps"],
  ["dse-p4-mock-2023-4-1-wearable-smart-devices", 2023, "4.1", "Wearable Smart Devices", "Wearable smart devices"],
  ["dse-p4-mock-2024-1-1-digital-museums", 2024, "1.1", "Digital Museums", "Digital museum"],
  ["dse-p4-mock-2025-1-3-smartphones-replacing-personal-computers", 2025, "1.3", "Smartphones Replacing Personal Computers", "As PC ownership declines, smartphones are on the rise"],
];
...
function run() {
  ...
  sets.forEach((set, index) => {
    ...
    const [id, year, version, title, sourcePhrase] = expected[index];
