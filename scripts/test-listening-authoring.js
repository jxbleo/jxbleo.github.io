...
assert.match(html, /id="il-practice-mode-trigger"/);
assert.match(html, /data-practice-listening-mode="shadowing"/);
...
assert.match(fs.readFileSync(path.join(root, "assets", "js", "intensive-listening.js"), "utf8"), /mode menu above to continue with Shadowing/);
...
assert.match(teacherHtml, /Mode previews/);
