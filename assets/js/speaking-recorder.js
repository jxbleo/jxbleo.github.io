(function (window) {
    ...
    function liveMarkup(date) {
        ...
        return '<dialog class="speaking-recording-state speaking-recording-live" id="recording-live" tabindex="-1" hidden aria-label="Discussion recording">' +
            ...
            '<div class="speaking-recording-footer"><button class="speaking-recording-upload-option" id="recording-upload-option" type="button"><svg viewBox="0 0 24 24" aria-hidden="true" data-icon="file-music"><path d="M11.65 22H18a2 2 0 0 0 2-2V8a2.4 2.4 0 0 0-.706-1.706l-3.588-3.588A2.4 2.4 0 0 0 14 2H6a2 2 0 0 0-2 2v10.35"/><path d="M14 2v5a1 1 0 0 0 1 1h5"/><path d="M8 20v-7l3 1.474"/><circle cx="6" cy="20" r="2"/></svg><span>Upload Files</span></button><input type="file" accept="audio/*" id="live-audio-file" hidden>' +
