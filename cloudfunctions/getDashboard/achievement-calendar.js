...
function buildAchievementCalendar({ attempts = [], sets = [], compositions = [], now = new Date() } = {}) {
  ...
  firstPassByKey.forEach((attempt, achievementKey) => {
    ...
    items.push({
      ...
      assignment_id: text(attempt.assignment_id) || null,
      attempt_id: text(attempt.attempt_id) || null,
  ...
  compositions.forEach((composition) => {
    ...
    items.push({
      ...
      type: "writing",
      composition_id: text(composition.composition_id || composition._id) || null,
